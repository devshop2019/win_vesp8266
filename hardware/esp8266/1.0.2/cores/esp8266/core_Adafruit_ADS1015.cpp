...
#include "core_Adafruit_ADS1015.h"
...
*/
/**************************************************************************/
Core_Adafruit_ADS1015::Core_Adafruit_ADS1015(uint8_t i2cAddress) {
...
*/
/**************************************************************************/
Core_Adafruit_ADS1115::Core_Adafruit_ADS1115(uint8_t i2cAddress) {
  m_i2cAddress = i2cAddress;
...
*/
/**************************************************************************/
void Core_Adafruit_ADS1015::begin() { Wire.begin(); }
...
*/
/**************************************************************************/
void Core_Adafruit_ADS1015::setGain(adsGain_t gain) { m_gain = gain; }
...
*/
/**************************************************************************/
adsGain_t Core_Adafruit_ADS1015::getGain() { return m_gain; }
...
*/
/**************************************************************************/
uint16_t Core_Adafruit_ADS1015::readADC_SingleEnded(uint8_t channel) {
  if (channel > 3) {
    return 0;
  }
...
*/
/**************************************************************************/
int16_t Core_Adafruit_ADS1015::readADC_Differential_0_1() {
  // Start with default values
  uint16_t config =
      ADS1015_REG_CONFIG_CQUE_NONE |    // Disable the comparator (default val)
      ADS1015_REG_CONFIG_CLAT_NONLAT |  // Non-latching (default val)
...
*/
/**************************************************************************/
int16_t Core_Adafruit_ADS1015::readADC_Differential_2_3() {
  // Start with default values
  uint16_t config =
      ADS1015_REG_CONFIG_CQUE_NONE |    // Disable the comparator (default val)
      ADS1015_REG_CONFIG_CLAT_NONLAT |  // Non-latching (default val)
...
*/
/**************************************************************************/
void Core_Adafruit_ADS1015::startComparator_SingleEnded(uint8_t channel,
                                                   int16_t threshold) {
  // Start with default values
  uint16_t config =
...
*/
/**************************************************************************/
int16_t Core_Adafruit_ADS1015::getLastConversionResults() {
  // Wait for the conversion to complete
  delay(m_conversionDelay);
