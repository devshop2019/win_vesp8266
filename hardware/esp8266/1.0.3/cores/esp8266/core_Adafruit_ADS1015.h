...
public:
  Core_Adafruit_ADS1015(uint8_t i2cAddress = ADS1015_ADDRESS);
  void begin(void);
...
*/
/**************************************************************************/
class Core_Adafruit_ADS1115 : public Core_Adafruit_ADS1015 {
public:
  Core_Adafruit_ADS1115(uint8_t i2cAddress = ADS1015_ADDRESS);
